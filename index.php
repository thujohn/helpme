 ...
 */
	...
	{
		define('ASSPATH', $assets_folder.'/');
	}
	else
	{
		define('ASSPATH', 'assets/');
	}
	...
	{
		define('UPPATH', 'assets/');
	}

	define('ABSOLUTE_PATH', str_replace('system/','', BASEPATH));

	define('ABSOLUTE_APPPATH', ABSOLUTE_PATH.APPPATH);

	define('ABSOLUTE_ASSPATH', ABSOLUTE_PATH.$assets_folder.'/');
