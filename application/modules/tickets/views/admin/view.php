...
<div id="doc-tpl">
	...
	<div class="prettyprint"><?php echo anchor('admin/attachment/get/ticket/'.$ticket->id, 'Pièce jointe', 'class="btn btn-small btn-danger"'); ?></div>
	<?php endif; ?>
	...
	<div class="prettyprint"><?php echo anchor('admin/attachment/get/response/'.$response->id, 'Pièce jointe', 'class="btn btn-small btn-danger"'); ?></div>
	<?php endif; ?>
	<?php endforeach; ?>
	...
	<?php echo form_open_multipart('', array('id' => 'frm_reply', 'class' => 'form-horizontal clearfix')); ?>
		...
		<?php echo anchor('admin/tickets/close/'.$ticket->id, 'Fermer', 'class="btn btn-success"'); ?>
